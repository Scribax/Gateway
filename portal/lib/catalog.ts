...
export const MODEL_CATALOG: ModelPrice[] = [
  ...
  { id: 'claude-sonnet-4-6', label: 'Claude Sonnet 4.6', input: 0.30, output: 1.50, cacheRead: 0.03, cacheWrite: 0.40, accent: 'blue' },
  { id: 'claude-sonnet-5', label: 'Claude Sonnet 5', input: 0.30, output: 1.50, cacheRead: 0.03, cacheWrite: 0.40, accent: 'blue' },
